						...
						<div class="box">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<c:forEach var="operators" items="${Operatorlist}">
										<tr>
											<td><c:out value="${operators.getIdoperators() }" /></td>
											<td><c:out value="${operators.getPerson() }" /></td>
											<td><c:out value="${operators.getFor_() }" /></td>
											<td>
											<c:choose>
												<c:when test="${operators.getWhatsapp() eq 'true'}">
													<span class="label label-success">Whats App</span> 
												</c:when>
											</c:choose>
											<c:choose>
												<c:when test="${operators.getPhonecall() eq 'true'}">
													<span class="label label-info">Phone Call</span> 
												</c:when>
											</c:choose>
											<c:choose>
												<c:when test="${operators.getSms() eq 'true'}">
													<span class="label label-warning">SMS</span> 
												</c:when>
											</c:choose>
											<c:choose>
												<c:when test="${operators.getEmail() eq 'true'}">
													<span class="label label-danger">eMail</span> 
												</c:when>
											</c:choose>	 
											<td><c:out value="${operators.getContact() }" /></td>
											<td><c:out value="${operators.getTimings() }" /></td>
										</tr>
									</c:forEach>
								</table>
							</div>
