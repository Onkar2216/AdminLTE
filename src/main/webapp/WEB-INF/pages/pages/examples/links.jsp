              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td><c:out value="${link.getIdLinks() }" /></td>
                      <td><c:out value="${link.getContent() }" /></td>
                      <td><a href="<c:out value="${link.getClick() }" />" target="_blank"><span class="label label-success">Go !</span></a>  </td>
                    </tr>
                    </c:forEach>
                  </table>
                </div><!-- /.box-body -->
