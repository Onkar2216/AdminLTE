        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="/images/onkar.jpg" class="img-circle" alt="User Image">
            </div>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="course" placeholder="Java/J2EE" type="text" name="courses">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="password" placeholder="Password" type="password" name="password">
                          <input type="hidden" name="idregistration" value='<c:out value="${loginid }"></c:out>' >
                      </div>
                    </div>
                  </div><!-- /.box-body -->
