...
<html>
  <head>
    ...
    <title>JavaByKiran | Update User</title>
          ...
          <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="loginpage" class="">LOGOUT</a>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p><a href="profile"><c:out value="${loginname}"/></a></p>
                ...
                <form class="form-horizontal" action="update" method="post"> 
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="username" placeholder="Username" type="text" name="username" value='<c:out value="${user.getUsername()}"/>'>
                      </div>
                    </div>                    
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Mobile</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="mobile" placeholder="Mobile" type="number" name="mobile" value="<c:out value='${user.getMobile()}'/>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Email</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="email" placeholder="Email" type="email" name="email" value="<c:out value='${user.getEmail()}'/>">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="course" placeholder="Java/J2EE" type="text" name="courses" value="<c:out value='${user.getCourses()}'/>">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        ...
                        <c:forEach var="state" items="${statelist }">
                         <option value='<c:out value="${state.getSid() }" />'><c:out value="${state.getStatename() }" /></option>                         
                          </c:forEach>
                        </select>
                      </div>
                    </div>                    
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="password" placeholder="Password" type="password" name="password" value="<c:out value='${user.getPassword()}'/>">
                          <input type="hidden" name="idregistration" value="<c:out value='${user.getIdregistration()}'/>" >
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-4" style="margin-top:6px;">
                        <input name="isDefault" required id="Y" value="Y" type="radio" style="margin-right:2px;"> Y
                        <input name="isDefault" required id="N" value="N" type="radio" style="margin-right:2px;margin-left:10px;" checked="checked">N
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  <div class="box-footer">
                    <button type="submit" id="submit"  class="btn btn-info pull-right" style="margin-left:5px;width:150px;">Update</button>
                    <a href="userlist"><span class="btn btn-default pull-right" style="width:150px;">Cancel</span></a>                   
                  </div><!-- /.box-footer -->
                </form>
                </c:forEach>
              </div><!-- /.box -->
